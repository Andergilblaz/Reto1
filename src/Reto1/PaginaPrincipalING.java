...
public class PaginaPrincipalING extends JFrame implements ActionListener {
  ...
  Component horizontalGlue;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PaginaPrincipalING frame = new PaginaPrincipalING();
	...
	public PaginaPrincipalING() {
		...
		btnResultados = new JButton("Results");
		...
		btnCalendario = new JButton("Schedule");
		...
		btnListaEquipos = new JButton("TeamList");
		...
		btnClasificacion = new JButton("League Table");
		...
		btnSobreNosotros = new JButton("About Us");
		...
		btnInicioSesion.setFocusPainted(false); //Elimina el contorno del centro del boton
		...
		btnContacto = new JButton("Contact");
		...
		contentPane.add(containerPanelLeft, BorderLayout.WEST);
	     ...
	     lblNoticias = new JLabel("Breaking News");
		...
		containerPanelRight.add(matchesPanel);
	     ...
	     lblProximosPartidos = new JLabel("Next Matches");
...
//Ejecutador de los botones
	...
	if (o == btnResultados){
		...
		ResultadosING.setAlwaysOnTop(true);
	}
			...
			CalendarioING.setAlwaysOnTop(true);
		}
				...
				ListaEquiposIngles.setAlwaysOnTop(true);
			}
				...
				ClasificaciónIngles.setAlwaysOnTop(true);
			}
