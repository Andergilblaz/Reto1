...
public class PaginaPrincipal extends JFrame implements ActionListener {
  ...
  private JButton btnNewButton;
	...
	public PaginaPrincipal() {
		...
		btnInicioDeSesion = new JButton("Iniciar Sesión");
		menuBar.add(btnInicioDeSesion);
		btnInicioDeSesion.setFont(new Font("Calibri", Font.BOLD, 20));
		btnInicioDeSesion.setBackground(new Color(139, 0, 0));
		btnInicioDeSesion.setForeground(new Color(255, 255, 255));
		btnInicioDeSesion.addActionListener(this);
		btnInicioDeSesion.setFocusPainted(false); //Elimina el contorno del centro del boton
