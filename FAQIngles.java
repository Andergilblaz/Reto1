...
public class FAQIngles extends JFrame {
	...
	public FAQIngles() {
        ...
        JLabel lblNewLabel_3 = new JLabel("<html>3: How to change the language of the application?<br>- There are currently 2 languages available to use the application: Spanish, English. To change <br> the language, use the \"Es/En\" menu.</html>");
        ...
        JLabel lblNewLabel_4 = new JLabel("<html>4: What should I do if the application is not working correctly?<br>- In this case, we recommend restarting the application, and also sending us a message through <br>the \"Contact\" menu, describing the problem.</html>");
        ...
        JLabel lblNewLabel_5 = new JLabel("<html>5: How to contact you?<br>- If you haven't found the answer to your question, you can always send us a message using <br>the \"Contact\" menu.</html>");
        ...
        JLabel lblNewLabel_6 = new JLabel("<html>6: How do I log in to the publisher account?<br>- If you are an editor, developer and/or administrator of this project, you must have your own username <br>and personal password.<br>To log in to your account, use the \"Login menu \", then enter your personal name and password.</html>");
